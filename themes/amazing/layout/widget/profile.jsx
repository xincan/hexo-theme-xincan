        ...
        return <div class="card widget">
            <div class="card-content">
                <nav class="level">
                    <div class="level-item has-text-centered flex-shrink-1">
                        <div>
                            ...
                            {author ? <p class="title is-size-4 is-block line-height-inherit" style="margin-top: 1em;" >{author}</p> : null}
                            {authorTitle ? <p class="is-size-6 is-block" style="margin-top: 0.7em;" >{authorTitle}</p> : null}
                            {location ? <p class="is-size-6 is-flex justify-content-center" style="margin-top: 0.7em;" >
                ...
                {followLink ? <div class="level">
                    <a class="level-item button is-primary is-rounded" href={followLink} target="_blank" rel="noopener" style="display:none;">{followTitle}aa</a>
					<img src={followLink} target="_blank" title={followTitle} style="border-radius: inherit;" />
				</div> : null}
